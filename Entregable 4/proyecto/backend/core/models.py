...
class ActividadDiaria(models.Model):
    ...
    id_orden_producción = models.ForeignKey('OrdenProducción', models.DO_NOTHING, db_column='id_orden_producción')
...
class AqlMuestra(models.Model):
    id_aql_nivel = models.ForeignKey('AqlNivel', models.DO_NOTHING, db_column='id_aql_nivel')
    ...
    id_aql_muestra = models.AutoField(primary_key=True)
...
class AqlResultadoRango(models.Model):
    ...
    id_aql_resultado_rango = models.AutoField(primary_key=True)
...
class InspeccionCalidad(models.Model):
    ...
    id_lote = models.ForeignKey('Lote', models.DO_NOTHING, db_column='id_lote')
    id_descripcion = models.ForeignKey('InspeccionDescripcion', models.DO_NOTHING, db_column='id_descripcion', blank=True, null=True)
    id_resultado = models.ForeignKey('Resultado', models.DO_NOTHING, db_column='id_resultado', blank=True, null=True)
    id_aql_muestra = models.ForeignKey(AqlMuestra, models.DO_NOTHING, db_column='id_aql_muestra')
    id_aql_resultado_rango = models.ForeignKey(AqlResultadoRango, models.DO_NOTHING, db_column='id_aql_resultado_rango')
...
class Lote(models.Model):
    ...
    id_actividad = models.ForeignKey(ActividadDiaria, models.DO_NOTHING, db_column='id_actividad', blank=True, null=True)
    fecha_creacion = models.DateTimeField()
...
class OrdenProducción(models.Model):
