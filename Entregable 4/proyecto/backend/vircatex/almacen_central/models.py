...
class ActividadDiaria(models.Model):
    ...
    id_orden_produccion = models.ForeignKey('OrdenProduccin', models.DO_NOTHING, db_column='id_orden_producci�n')
...
class AqlMuestra(models.Model):
    ...
    id_aql_lote_rango = models.CharField(max_length=255, unique=True)
...
class Lote(models.Model):
    ...
    cantidad = models.IntegerField()
    # id_estado = models.ForeignKey(Estado, models.DO_NOTHING, db_column='id_estado')
    id_estado = models.ForeignKey('Estado', on_delete=models.DO_NOTHING)
